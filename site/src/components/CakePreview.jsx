  ...
  return (
    <div className="cake-preview">
      ...
      <div className="plate-wrapper">
        ...
        {tier >= 1 && (
          <img
            src={getImage(`/src/assets/flavors/${flavor}-tier-1.png`)}
            className="cake-img cake-tier-1"
          />
        )}
        {tier >= 2 && (
          <img
            src={getImage(`/src/assets/flavors/${flavor}-tier-2.png`)}
            className="cake-img cake-tier-2"
          />
        )}
        {tier >= 3 && (
          <img
            src={getImage(`/src/assets/flavors/${flavor}-tier-3.png`)}
        ...
        {icing && tier >= 1 && (
          <img
            src={getImage(`/src/assets/icing/${icing}-tier-1.png`)}
            className="icing-img icing-tier-1"
          />
        )}
        {icing && tier >= 2 && (
          <img
            src={getImage(`/src/assets/icing/${icing}-tier-2.png`)}
            className="icing-img icing-tier-2"
          />
        )}
        {icing && tier >= 3 && (
          <img
            src={getImage(`/src/assets/icing/${icing}-tier-3.png`)}
        ...
        {decor.includes("ruffles") && tier >= 2 && (
          <img
            src={getImage(`/src/assets/decor/ruffles-tier-2.png`)}
            className="decor-img decor-ruffles-2"
          />
        )}
        {decor.includes("ruffles") && tier >= 3 && (
          <img
            src={getImage(`/src/assets/decor/ruffles-tier-3.png`)}
        ...
        {decor.includes("border") && tier >= 1 && (
          <img
            src={getImage(`/src/assets/decor/border-tier-1.png`)}
            className="decor-img decor-border-1"
          />
        )}
        {decor.includes("border") && tier >= 2 && (
          <img
            src={getImage(`/src/assets/decor/border-tier-2.png`)}
        ...
        {decor.includes("roses") && tier >= 1 && (
          <img
            src={getImage(`/src/assets/decor/roses-tier-1.png`)}
        ...
        {decor.includes("roses") && tier >= 3 && (
          <img
            src={getImage(`/src/assets/decor/roses-tier-3.png`)}
        ...
        {fruit && tier >= 1 && (
          <img
            src={getImage(`/src/assets/fruits/${fruit}-side.png`)}
    ...
    {decor.includes("bottom-border") && (
      <img
        src={getImage("/src/assets/top-decor/border-top-bottom.png")}
    ...
    {!icing && tier >= 1 && (
      <img
        src={getImage(`/src/assets/top-view/${flavor}-flavor-top.png`)}
    ...
    {icing && tier >= 1 && (
      <img
        src={getImage(`/src/assets/top-view/${icing}-icing-top.png`)}
        className="top-cake top-cake-1"
      />
    )}
    ...
    {decor.includes("border") && tier >= 1 && (
      <img
        src={getImage("/src/assets/top-decor/border-top-1.png")}
    ...
    {decor.includes("border") && tier >= 2 && (
      <img
        src={getImage("/src/assets/top-decor/border-top-2.png")}
    ...
    {decor.includes("border") && tier >= 3 && (
      <img
        src={getImage("/src/assets/top-decor/border-top-3.png")}
    ...
    {fruit && (
      <img
        src={getImage(`/src/assets/fruits/${fruit}-top.png`)}
